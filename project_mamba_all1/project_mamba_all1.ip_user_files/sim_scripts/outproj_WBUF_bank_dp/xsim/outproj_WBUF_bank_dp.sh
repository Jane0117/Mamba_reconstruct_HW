...
#
# Script generated by Vivado on Mon Mar 30 12:35:14 +0200 2026
...
simulate()
{
  xsim outproj_WBUF_bank_dp -key {Behavioral:sim_4:Functional:outproj_WBUF_bank_dp} -tclbatch cmd.tcl -log simulate.log
}
