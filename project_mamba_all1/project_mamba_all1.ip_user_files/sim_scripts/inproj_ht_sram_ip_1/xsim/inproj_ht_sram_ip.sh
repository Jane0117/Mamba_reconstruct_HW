...
#
# Script generated by Vivado on Tue Mar 31 13:07:57 +0200 2026
...
simulate()
{
  xsim inproj_ht_sram_ip -key {Behavioral:sim_4:Functional:inproj_ht_sram_ip} -tclbatch cmd.tcl -log simulate.log
}
